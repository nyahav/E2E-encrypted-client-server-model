...
class ClientsHandler:
    ...
    def returnGeneralError(self, clientSocket):
        version = VERSION
        responseCode = ResponseAuth.GENERAL_ERROR_RESP
        payloadSize = 0
    ...
    def registerRequestHandler(self, clientSocket, payloadSize):
        ...
        version = VERSION
        responseCode = ResponseAuth.REGISTER_SUCCESS_RESP
    ...
    def clientsListRequestHandler(self, clientSocket, srcUUID):
        ...
        # Sets the values of the response header.
        version = VERSION
        responseCode = ResponseAuth.CLIENTS_LIST_RESP
    ...
    def getPublicKeyRequest(self, clientSocket, payloadSize, srcUUID):
        ...
        version = VERSION
        responseCode = ResponseAuth.GET_PUBLIC_KEY_RESP
    ...
    def sendMessageRequestHandler(self,clientSocket, payloadSize, srcUUID):
        ...
        # Sets the values of the response header.
        version = VERSION
        responseCode = ResponseAuth.MESSAGE_SENT_RESP
    ...
    def getWaitingMessages(self, clientSocket, srcUUID,destUUID):
        ...
        # Sets the values of the response header.
        version = VERSION
        responseCode = ResponseAuth.PULL_WAITING_MESSAGES_RESP
